...
class MovementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create movement" do
    assert_difference('Movement.count') do
      post movements_url, params: { movement: { account_id: @movement.account_id, cantidad: @movement.cantidad, concept_id: @movement.concept_id, descripcion: @movement.descripcion, goal_id: @movement.goal_id, user_id: @movement.user_id } }
    end
  ...
  test "should update movement" do
    patch movement_url(@movement), params: { movement: { account_id: @movement.account_id, cantidad: @movement.cantidad, concept_id: @movement.concept_id, descripcion: @movement.descripcion, goal_id: @movement.goal_id, user_id: @movement.user_id } }
