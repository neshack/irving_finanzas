...
class ConceptsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create concept" do
    assert_difference('Concept.count') do
      post concepts_url, params: { concept: { descripcion: @concept.descripcion, nombre: @concept.nombre, tipo: @concept.tipo, user_id: @concept.user_id } }
    end
  ...
  test "should update concept" do
    patch concept_url(@concept), params: { concept: { descripcion: @concept.descripcion, nombre: @concept.nombre, tipo: @concept.tipo, user_id: @concept.user_id } }
